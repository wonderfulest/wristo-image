  ...
  <main class="image-editor" tabindex="0" @paste="onPaste" @dragover.prevent @drop.prevent="onDrop">
    ...
    <div class="editor-body">
      ...
      <section class="editor-workspace">
        ...
        <footer class="workspace-footer"><span>最大 25 MB · 8192 × 8192 px</span><div class="zoom-controls"><button @click="changeZoom(-.1)">−</button><button @click="viewScale = 1">100%</button><button @click="changeZoom(.1)">＋</button><button @click="fitView">适应</button></div></footer>
      </section>
    </div>
