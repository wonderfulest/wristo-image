  ...
  <main class="compressor-page" tabindex="-1" @drop.prevent="onDrop" @dragover.prevent @paste="onPaste">
    ...
    <section class="compressor-workbench">
      ...
      <section class="compressor-preview">
        ...
        <div class="preview-canvas compressor-checker">
